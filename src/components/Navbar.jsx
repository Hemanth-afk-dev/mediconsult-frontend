    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-md border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <button className="text-slate-300 hover:text-white text-sm font-medium px-4 py-2 transition">
            Login
          </button>
          <button className="bg-cyan-500 hover:bg-cyan-400 text-white text-sm font-semibold px-5 py-2 rounded-full transition">
            Get Started
          </button>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-slate-900 px-6 pb-6 flex flex-col gap-4">
          ...
          <button className="bg-cyan-500 text-white text-sm font-semibold px-5 py-2 rounded-full w-fit">
            Get Started
          </button>
        </div>
      )}
