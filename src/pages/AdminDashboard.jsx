...
import { Users, UserCheck, Calendar, Shield, Bell, LogOut, Settings, BarChart3, Stethoscope, ChevronRight, CheckCircle, XCircle, Clock } from 'lucide-react'
      ...
      <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col fixed h-full">
        ...
        <div className="px-6 py-5 border-b border-slate-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-rose-400 to-amber-400 flex items-center justify-center text-slate-900 font-bold text-sm">AD</div>
            <div>
